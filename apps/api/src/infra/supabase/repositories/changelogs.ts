...
export async function createChangelog(params: CreateChangelogParams): Promise<ChangelogRecord> {
  ...
  if (insertError) {
    logger.error(insertError instanceof Error ? insertError : new Error(String(insertError)), "Error creating changelog");
    throw insertError;
  }
  ...
  if (error) {
    logger.error(error as Error, "Error fetching created changelog");
    throw error;
  }
...
export async function getChangelogs(
  ...
  if (error) {
    logger.error(error as Error, "Error fetching changelogs");
    throw error;
  }
...
export async function getChangelogByVersion(version: string): Promise<PublicChangelogRecord | null> {
  ...
  if (error) {
    ...
    logger.error(error as Error, "Error fetching changelog by version");
    throw error;
  }
...
export async function getChangelogById(id: string): Promise<ChangelogRecord | null> {
  ...
  if (error) {
    ...
    logger.error(error as Error, "Error fetching changelog by ID");
    throw error;
  }
...
export async function updateChangelog(id: string, params: UpdateChangelogParams): Promise<ChangelogRecord> {
  ...
  if (updateError) {
    logger.error(updateError instanceof Error ? updateError : new Error(String(updateError)), "Error updating changelog");
    throw updateError;
  }
  ...
  if (error) {
    logger.error(error as Error, "Error fetching updated changelog");
    throw error;
  }
...
export async function deleteChangelog(id: string): Promise<void> {
  ...
  if (error) {
    logger.error(error as Error, "Error deleting changelog");
    throw error;
  }
}
...
export async function getAllChangelogsForAdmin(
  ...
  if (error) {
    logger.error(error as Error, "Error fetching all changelogs for admin");
    throw error;
  }
