...
export async function getInterestTagById(id: string) {
  ...
  if (error) {
    ...
    logger.error(toLoggableError(error), "Error fetching interest tag");
    throw error;
  }
...
export async function getInterestTagsByIds(ids: string[]) {
  ...
  if (error) {
    logger.error(toLoggableError(error), "Error fetching interest tags by IDs");
    throw error;
  }
...
export async function getInterestTagNamesByIds(ids: string[]) {
  ...
  if (error) {
    logger.error(toLoggableError(error), "Error fetching interest tag names");
    throw error;
  }
...
export async function createInterestTag(data: InterestTagInsert) {
  ...
  if (error) {
    logger.error(toLoggableError(error), "Error creating interest tag");
    throw error;
  }
...
export async function updateInterestTag(id: string, data: InterestTagUpdate) {
  ...
  if (error) {
    ...
    logger.error(toLoggableError(error), "Error updating interest tag");
    throw error;
  }
...
export async function deleteInterestTag(id: string) {
  ...
  if (error) {
    ...
    logger.error(toLoggableError(error), "Error deleting interest tag");
    throw error;
  }
...
export async function deleteInterestTagHard(id: string) {
  ...
  if (error) {
    logger.error(toLoggableError(error), "Error hard deleting interest tag");
    throw error;
  }
