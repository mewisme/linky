...
export async function getInterestTagById(id: string) {
  ...
  if (error) {
    ...
    logger.error("Error fetching interest tag: %o", error as Error);
    throw error;
  }
...
export async function getInterestTagsByIds(ids: string[]) {
  ...
  if (error) {
    logger.error("Error fetching interest tags by IDs: %o", error as Error);
    throw error;
  }
...
export async function getInterestTagNamesByIds(ids: string[]) {
  ...
  if (error) {
    logger.error("Error fetching interest tag names: %o", error as Error);
    throw error;
  }
...
export async function createInterestTag(data: InterestTagInsert) {
  ...
  if (error) {
    logger.error("Error creating interest tag: %o", error as Error);
    throw error;
  }
...
export async function updateInterestTag(id: string, data: InterestTagUpdate) {
  ...
  if (error) {
    ...
    logger.error("Error updating interest tag: %o", error as Error);
    throw error;
  }
...
export async function deleteInterestTag(id: string) {
  ...
  if (error) {
    ...
    logger.error("Error deleting interest tag: %o", error as Error);
    throw error;
  }
...
export async function deleteInterestTagHard(id: string) {
  ...
  if (error) {
    logger.error("Error hard deleting interest tag: %o", error as Error);
    throw error;
  }
