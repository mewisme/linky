...
export async function getStreakExpBonusForStreak(streakLength: number): Promise<StreakExpBonusRecord | null> {
  ...
  if (error) {
    ...
    logger.error("Error fetching streak EXP bonus: %o", error instanceof Error ? error : new Error(String(error)));
    throw error;
  }
...
export async function getAllStreakExpBonuses(): Promise<StreakExpBonusRecord[]> {
  ...
  if (error) {
    logger.error("Error fetching all streak EXP bonuses: %o", error instanceof Error ? error : new Error(String(error)));
    throw error;
  }
...
export async function createStreakExpBonus(data: StreakExpBonusInsert): Promise<StreakExpBonusRecord> {
  ...
  if (error) {
    logger.error("Error creating streak EXP bonus: %o", error instanceof Error ? error : new Error(String(error)));
    throw error;
  }
...
export async function updateStreakExpBonus(id: string, data: StreakExpBonusUpdate): Promise<StreakExpBonusRecord> {
  ...
  if (error) {
    ...
    logger.error("Error updating streak EXP bonus: %o", error instanceof Error ? error : new Error(String(error)));
    throw error;
  }
...
export async function deleteStreakExpBonus(id: string): Promise<void> {
  ...
  if (error) {
    logger.error("Error deleting streak EXP bonus: %o", error instanceof Error ? error : new Error(String(error)));
    throw error;
  }
}
