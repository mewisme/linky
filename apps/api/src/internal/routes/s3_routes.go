...
func s3ListObjects(ctx context.Context, prefix string) ([]map[string]any, error) {
	if s3Client == nil {
	...
	objs := make([]map[string]any, 0, len(out.Contents))
	for _, o := range out.Contents {
		...
		if o.LastModified != nil {
			entry["lastModified"] = o.LastModified.UTC().Format(time.RFC3339Nano)
		}
		if o.ETag != nil {
