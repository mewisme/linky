...
mqttClient.on('message', async (topic, message) => {
  ...
  // Handle presence message (Redis updates + admin notifications)
  await handlePresenceMessage(clientId, state)
})

/**
 * Attach Socket.IO instance to MQTT module
 * This sets up admin cache tracking and presence handler
 */
