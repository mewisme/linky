...
export async function GET(request: NextRequest) {
  try {
    ...
    logger.error("Error in /api/users/user-details/me:", error);
    return NextResponse.json(
...
export async function PUT(request: NextRequest) {
  try {
    ...
    logger.error("Error in PUT /api/users/user-details/me:", error);
    return NextResponse.json(
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    logger.error("Error in PATCH /api/users/user-details/me:", error);
    return NextResponse.json(
      { error: "Internal Server Error", message: "Failed to update user details" },
      { status: 500 }
    );
