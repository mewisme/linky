...
export async function getCallHistory(
  ...
  return withSentryQuery("getCallHistory", async () =>
    serverFetch<ResourcesAPI.CallHistory.Get.Response>(
      backendUrl.resources.callHistory(buildQuery(params)),
    ),
  );
}
...
export async function getCallHistoryById(
  ...
  return withSentryQuery("getCallHistoryById", async () =>
    serverFetch<ResourcesAPI.CallHistory.GetById.Response>(
      backendUrl.resources.callHistoryById(id),
    ),
  );
}
