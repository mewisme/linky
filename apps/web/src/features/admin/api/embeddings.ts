...
export async function syncEmbeddings(
  ...
  return withSentryAction("syncEmbeddings", async () => {
    return serverFetch<GoEmbeddingSyncResponse>(
      backendUrl.admin.embeddingsSync(),
      {
        method: "POST",
...
export async function compareEmbeddings(
  ...
  return withSentryAction("compareEmbeddings", async () => {
    return serverFetch<GoEmbeddingCompareResponse>(
      backendUrl.admin.embeddingsCompare(),
      {
        method: "POST",
...
export async function findSimilarUsers(
  ...
  return withSentryAction("findSimilarUsers", async () => {
    return serverFetch<GoEmbeddingSimilarResponse>(
      backendUrl.admin.embeddingsSimilar(),
      {
        method: "POST",
...
export async function syncAllEmbeddings(): Promise<EmbeddingSyncAllResponse> {
  return withSentryAction("syncAllEmbeddings", async () => {
    return serverFetch<GoEmbeddingSyncAllResponse>(
      backendUrl.admin.embeddingsSyncAll(),
      {
        method: "POST",
      },
    );
