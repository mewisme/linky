...
export async function getAdminUsers(
  ...
  return withSentryQuery("getAdminUsers", async () =>
    serverFetch<AdminAPI.GetUsers.Response>(
      backendUrl.admin.users(searchParams),
    ),
  );
}
...
export async function updateAdminUser(
  ...
  return withSentryAction("updateAdminUser", async () =>
    serverFetch<AdminAPI.UpdateUser.Response>(backendUrl.admin.userById(id), {
      method: "PUT",
...
export async function softDeleteAdminUser(
  id: string,
): Promise<AdminAPI.PatchUser.Response> {
  return withSentryAction("softDeleteAdminUser", async () =>
    serverFetch<AdminAPI.PatchUser.Response>(backendUrl.admin.userById(id), {
      method: "PATCH",
      body: JSON.stringify({
        deleted: true,
...
export async function softDeleteAdminUsers(
  ids: string[],
): Promise<AdminAPI.PatchUsersBatch.Response> {
...
export async function hardDeleteAdminUser(
  id: string,
): Promise<AdminAPI.DeleteUser.Response> {
  return withSentryAction("hardDeleteAdminUser", async () =>
    serverFetch<AdminAPI.DeleteUser.Response>(backendUrl.admin.userById(id), {
      method: "DELETE",
    }),
  );
}

export async function hardDeleteAdminUsers(
  ids: string[],
): Promise<{ deleted: number }> {
  return withSentryAction("hardDeleteAdminUsers", async () =>
    serverFetch<{ deleted: number }>(backendUrl.admin.usersBatch(), {
      method: "DELETE",
...
export async function restoreAdminUsers(
  ...
  return withSentryAction("restoreAdminUsers", async () =>
    serverFetch<AdminAPI.PatchUsersBatch.Response>(
      ...
      {
        method: "PATCH",
        body: JSON.stringify({ ids, deleted: false, deleted_at: null }),
      },
    ),
  );
}
