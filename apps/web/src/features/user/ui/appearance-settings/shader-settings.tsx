      ...
      <div className="grid gap-4">
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            <Label htmlFor="shader-animation">
              {t("appearancePage.shaderAnimation")}
            </Label>
            <p className="text-sm text-muted-foreground">
              {t("appearancePage.shaderAnimationHint")}
            </p>
          </div>
          <Switch
            id="shader-animation"
        ...
        <div className="flex items-center  justify-between">
          <div className="space-y-2">
            <Label htmlFor="shader-type">
              {t("appearancePage.shaderType")}
            </Label>
            <p className="text-sm text-muted-foreground">
              {t("appearancePage.shaderTypeHint")}
            </p>
          </div>
          <Select
            value={shaderType}
            onValueChange={(value) =>
              setShaderType((value as ShaderType) ?? "gem-smoke")
            }
            disabled={disabled}
          >
            ...
            <SelectContent>
              <SelectItem value="gem-smoke">
                {t("appearancePage.shaderTypeGemSmoke")}
              </SelectItem>
              <SelectItem value="liquid-metal">
                {t("appearancePage.shaderTypeLiquidMetal")}
              </SelectItem>
              <SelectItem value="heatmap">
                {t("appearancePage.shaderTypeHeatmap")}
              </SelectItem>
              <SelectItem value="mesh-gradient">
                {t("appearancePage.shaderTypeMeshGradient")}
              </SelectItem>
              <SelectItem value="warp">
                {t("appearancePage.shaderTypeWarp")}
              </SelectItem>
              <SelectItem value="spiral">
                {t("appearancePage.shaderTypeSpiral")}
              </SelectItem>
              <SelectItem value="swirl">
                {t("appearancePage.shaderTypeSwirl")}
              </SelectItem>
              <SelectItem value="neuro-noise">
                {t("appearancePage.shaderTypeNeuroNoise")}
              </SelectItem>
              <SelectItem value="perlin-noise">
                {t("appearancePage.shaderTypePerlinNoise")}
              </SelectItem>
              <SelectItem value="god-rays">
                {t("appearancePage.shaderTypeGodRays")}
              </SelectItem>
            </SelectContent>
          </Select>
        </div>
        <div className="flex  items-center justify-between">
          <div className="space-y-2">
            <Label htmlFor="shader-preset">
              {t("appearancePage.shaderPreset")}
            </Label>
            <p className="text-sm text-muted-foreground">
              {t("appearancePage.shaderPresetHint")}
            </p>
          </div>
          <Select
            value={shaderPreset}
