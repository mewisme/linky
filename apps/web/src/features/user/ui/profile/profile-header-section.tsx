...
export function ProfileHeaderSection({
  ...
  const handleSave = () => {
    const nextFirstNameError = resolveProfileNameErrorMessage(
      tp,
      validateProfileName(firstName),
    );
    const nextLastNameError = resolveProfileNameErrorMessage(
      tp,
      validateOptionalProfileName(lastName),
    );
          ...
          <div className="w-full space-y-3">
            <div className="grid grid-cols-1 gap-2 sm:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_auto]">
              <div className="space-y-1">
                ...
                <FieldError
                  errors={
                    firstNameError ? [{ message: firstNameError }] : undefined
                  }
                />
              </div>
              <div className="space-y-1">
                ...
                <FieldError
                  errors={
                    lastNameError ? [{ message: lastNameError }] : undefined
                  }
                />
              </div>
              <ComboboxCountry
