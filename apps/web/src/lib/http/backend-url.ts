...
export const backendUrl = {
  ...
  resources: {
    ...
    videoFilterPresets: (params?: URLSearchParams) => `${V1}/video-filter-presets${qs(params)}`,
    videoFilterPresetById: (id: string) => `${V1}/video-filter-presets/${id}`,
  ...
  admin: {
    ...
    videoFilterPresets: (params?: URLSearchParams) => `${V1}/admin/video-filter-presets${qs(params)}`,
    videoFilterPresetById: (id: string) => `${V1}/admin/video-filter-presets/${id}`,
