...
export const SERVER_EVENT_NAMES = [
  ...
  "api_admin_exp_bonuses_get",
  "api_admin_exp_bonuses_post",
  "api_admin_exp_bonuses_id_get",
  "api_admin_exp_bonuses_id_put",
  "api_admin_exp_bonuses_id_patch",
  "api_admin_exp_bonuses_id_delete",
