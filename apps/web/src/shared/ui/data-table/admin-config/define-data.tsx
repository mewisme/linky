...
export function useAdminConfigColumns(
  callbacks?: RowCallbacks,
): ColumnDef<AdminAPI.Config.Item>[] {
  const t = useTranslations("dataTable");
  return useMemo(
    () => [
      {
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div
            className="max-w-md truncate font-mono text-sm"
            title={formatValue(row.original.value)}
          >
