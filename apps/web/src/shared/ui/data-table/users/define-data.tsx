...
import {
  ...
  StatusIndicator,
  StatusLabel,
} from "@ws/ui/components/kibo-ui/status";
import {
  ActionsButton,
  type ActionItem,
  ...
  return useMemo(
    () => [
      ...
      },
      {
        ...
        cell: ({ row }) => {
          const avatarUrl = row.getValue("avatar_url") as
            | string
            | null
            | undefined;
          return (
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <Badge variant="outline" className="text-muted-foreground px-1.5">
            ...
            {row.original.deleted
              ? td("users.deletedBadge")
              : td("users.activeBadge")}
          </Badge>
        ),
      },
      {
        ...
        cell: ({ row }) => (
          <div
            ...
            title={row.original.details?.bio ?? undefined}
          >
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div>
            {row.original.embedding ? td("users.synced") : td("users.none")}
          </div>
        ),
      },
      {
      ...
      {
        id: "actions",
        cell: ({ row }) => <UserActionsCell row={row} callbacks={callbacks} />,
        enableHiding: false,
        enableSorting: false,
      },
    ],
