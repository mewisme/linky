...
def test_edit_button_appears_on_header_hover(driver):
    """Profile — Name & Country Editing: Edit button appears on header hover"""
    """Profile — Name & Country Editing: Edit button appears on header hover"""
    ...
    hover_section(driver, header)
    assert button_by_name(driver, r"edit").is_displayed()
