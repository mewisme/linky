...
def test_clicking_edit_shows_name_and_country_edit_form(driver):
    """Profile — Name & Country Editing: Clicking edit shows name and country edit form"""
    """Profile — Name & Country Editing: Clicking edit shows name and country edit form"""
    ...
    assert find_by_placeholder(driver, r"first name").is_displayed()
    assert find_by_placeholder(driver, r"last name").is_displayed()
    assert button_by_name(driver, r"save").is_displayed()
    assert button_by_name(driver, r"cancel").is_displayed()
