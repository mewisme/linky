...
def test_bio_displays_not_provided_when_empty(driver):
    """Profile Page — Page Load & Display: Bio displays "Not provided" when empty"""
    """Profile Page — Page Load & Display: Bio displays"""
