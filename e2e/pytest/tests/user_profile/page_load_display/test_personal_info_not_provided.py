...
def test_personal_info_shows_not_provided_for_empty_fields(driver):
    """Profile Page — Page Load & Display: Personal info shows "Not provided" for empty fields"""
    """Profile Page — Page Load & Display: Personal info shows"""
