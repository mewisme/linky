...
def test_edit_button_appears_on_hover(driver):
    """Profile — Personal Info: Edit button appears on hover"""
    """Profile — Personal Info: Edit button appears on hover"""
    ...
    hover_section(driver, pinfo)
    assert edit_button_in(pinfo).is_displayed()
