...
def test_navigate_to_development_settings(driver):
    """Settings Navigation: Navigate to Development settings"""
    """Settings Navigation: Navigate to Development settings"""
    authenticate_user(driver, TEST_USERS['user1'])
    driver.get(settings.base_url + '/settings')
    wait_page_loaded(driver)
    link_by_name(driver, r"development").click()
    wait_for_url(driver, r"/settings/development")
