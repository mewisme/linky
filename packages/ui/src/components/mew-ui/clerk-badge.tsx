...
export function ClerkBadge({ content, color = "bg-blue-50" }: { content: string, color?: string }) {
  return (
    <span className={cn(color, "relative px-[0.1875rem] font-medium text-[0.625rem]/[0.875rem]")}>
      {content}
