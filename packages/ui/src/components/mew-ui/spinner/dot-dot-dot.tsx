...
export function SpinnerDotDotDot({ size = 28 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <style>{`
        ...
        @keyframes f00110000 { 0% { opacity: 0; } 24.99% { opacity: 0; } 25.00% { opacity: 1; } 49.99% { opacity: 1; } 50.00% { opacity: 0; } 100% { opacity: 0; } }
        @keyframes f00001100 { 0% { opacity: 0; } 49.99% { opacity: 0; } 50.00% { opacity: 1; } 74.99% { opacity: 1; } 75.00% { opacity: 0; } 100% { opacity: 0; } }
        @keyframes f00000011 { 0% { opacity: 0; } 74.99% { opacity: 0; } 75.00% { opacity: 1; } 100% { opacity: 1; } }
      `}</style>
      ...
      <circle className="on" cx="9" cy="21" r="2" opacity={0} style={{ animation: 'f00110000 var(--dur) linear infinite' }} />
      <circle cx="15" cy="21" r="2" />
      <circle cx="21" cy="21" r="2" />
      <circle className="on" cx="21" cy="21" r="2" opacity={0} style={{ animation: 'f00001100 var(--dur) linear infinite' }} />
      <circle cx="27" cy="21" r="2" />
      <circle cx="33" cy="21" r="2" />
      <circle className="on" cx="33" cy="21" r="2" opacity={0} style={{ animation: 'f00000011 var(--dur) linear infinite' }} />
