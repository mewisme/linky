...
def test_bio_edit_button_appears_on_hover(driver):
    """Profile — Bio Section: Bio edit button appears on hover"""
    """Profile — Bio Section: Bio edit button appears on hover"""
    ...
    hover_section(driver, sec)
    assert edit_button_in(sec).is_displayed()
