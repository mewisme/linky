...
def test_save_bio_updates_display(driver):
    """Profile — Bio Section: Save bio updates display"""
    """Profile — Bio Section: Save bio updates display"""
    ...
    textarea.clear()
    textarea.send_keys("My updated bio text for testing")
    save_button_in(sec).click()
    wait_for_text(driver, r"bio updated", timeout=10)
    wait_for_text(driver, r"My updated bio text for testing")
