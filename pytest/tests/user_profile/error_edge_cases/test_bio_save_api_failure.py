...
def test_bio_save_api_failure_shows_error_toast(driver):
    """Error & Edge Cases: Bio save API failure shows error toast"""
    """Error & Edge Cases: Bio save API failure shows error toast"""
    ...
    textarea.clear()
    textarea.send_keys("This should fail")
    with block_url_pattern(driver, '**/api/**/user/bio**'):
