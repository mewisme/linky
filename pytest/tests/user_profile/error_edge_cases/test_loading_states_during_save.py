...
def test_loading_states_display_during_save_operations(driver):
    """Error & Edge Cases: Loading states display during save operations"""
    """Error & Edge Cases: Loading states display during save operations"""
    ...
    textarea.clear()
    textarea.send_keys("Test loading states")
