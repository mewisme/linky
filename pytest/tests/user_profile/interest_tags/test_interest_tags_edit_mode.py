...
def test_click_edit_enters_tag_selection_mode(driver):
    """Profile — Interest Tags: Click edit enters tag selection mode"""
    """Profile — Interest Tags: Click edit enters tag selection mode"""
    ...
    assert cancel_button_in(interests).is_displayed()
