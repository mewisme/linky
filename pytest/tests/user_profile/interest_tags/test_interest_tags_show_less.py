...
def test_show_less_collapses_tags_back(driver):
    """Profile — Interest Tags: Show less collapses tags back"""
    """Profile — Interest Tags: Show less collapses tags back"""
    ...
    visible = [b for b in show_more if b.is_displayed()]
    if visible:
        visible[0].click()
        button_by_name(driver, r"show less").click()
        assert button_by_name(driver, r"show more").is_displayed()
