...
def test_clear_gender_saves_as_null(driver):
    """Profile — Personal Info: Clear gender saves as null"""
    """Profile — Personal Info: Clear gender saves as null"""
    ...
    comboboxes = pinfo.find_elements(By.CSS_SELECTOR, '[role="combobox"]')
    if selects:
