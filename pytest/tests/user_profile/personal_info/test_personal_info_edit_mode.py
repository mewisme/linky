...
def test_click_edit_opens_inline_editing_for_date_of_birth_and_gender(driver):
    """Profile — Personal Info: Click edit opens inline editing for date of birth and gender"""
    """Profile — Personal Info: Click edit opens inline editing for date of birth and gender"""
    ...
    assert save_button_in(pinfo).is_displayed()
    assert cancel_button_in(pinfo).is_displayed()
