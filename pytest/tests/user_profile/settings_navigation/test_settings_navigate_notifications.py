...
def test_navigate_to_notification_settings(driver):
    """Settings Navigation: Navigate to Notification settings"""
    """Settings Navigation: Navigate to Notification settings"""
    authenticate_user(driver, TEST_USERS['user1'])
    driver.get(settings.base_url + '/settings')
    wait_page_loaded(driver)
    link_by_name(driver, r"notifications").click()
    wait_for_url(driver, r"/settings/notifications")
